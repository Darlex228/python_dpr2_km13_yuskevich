...
def is_valid_word(word, hand, word_list):
    ...
    for i in VOWELS:
        ...
        if is_valid_word(new_word, new_hand, word_list):
            return True
    return False
...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while calculate_handlen(hand) > 0:
        display_hand(hand)
        word = input('Enter word, or "!!" if you are done: ')
        if word == '!!':
            break
        else:
            if is_valid_word(word, hand, word_list):
                ...
                total_score += point
                print(word, 'earned', point, 'points. Total:', total_score, 'points')
            else:
                print('This is not a valid word so choose another word.')
...
def substitute_hand(hand, letter):
    ...
    new_hand = hand.copy()
    new_hand[new_letters] = new_hand[letter]
    new_hand[letter] = 0
    return new_hand
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    while True:
        ...
        if total_hands.isdigit():
            total_hands = int(total_hands)
            break
        else:
            print('You did not enter a number so try again.')
            continue
    ...
    while total_hands > 0:
        ...
        if input('Would you like to substitute a letter? ').lower() == 'yes':
            while True:
                ...
                if len(letter_replace) != 1:
                    print('You have entered wrong amount of letters so try again.')
                    continue
                elif letter_replace.isalpha():
                    hand = substitute_hand(hand, letter_replace)
                    break
                else:
                    print('That was not a letter so try again.')
                    continue
        score1 = 0
        score2 = 0
        ...
        hands_score += max(score1, score2)
        total_hands -= 1


    print()
    print('Total score over all hands:', hands_score)
